...
public class KullaniciGirisi extends AbstractFrame {
					...
					.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING, false)
						.addGroup(jPanel1Layout.createSequentialGroup()
							...
							.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
								.addComponent(txt_kullanici_adi, GroupLayout.PREFERRED_SIZE, 168, GroupLayout.PREFERRED_SIZE)
								.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING, false)
									.addComponent(txt_sifre)
									.addGroup(jPanel1Layout.createSequentialGroup()
										.addComponent(jButton12, GroupLayout.PREFERRED_SIZE, 65, GroupLayout.PREFERRED_SIZE)
										.addGap(18)
										.addComponent(jButton14, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE)))))
						.addComponent(lblKullancAdTc, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
					...
					.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
						.addGroup(jPanel1Layout.createSequentialGroup()
							...
							.addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE)
								.addComponent(txt_kullanici_adi, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
	...
	private void jButton14ActionPerformed(ActionEvent evt) {
		try {
			...
			} else if (kullanici_adi.length() <= 6) {
