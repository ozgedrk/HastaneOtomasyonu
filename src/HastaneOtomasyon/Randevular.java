...
public class Randevular extends AbstractFrame implements Formatter {
	...
	public Randevular() {
		...
		setTitle("Kayseri Eğitim ve Araştırma Hastanesi Hekim Randevu Sistemi");
		initComponents();
	...
	private void initComponents() {
		...
		jLabel2.setText("Kayseri Eğitim Ve Araştırma Hastanesi Hekim Randevu Sistemi");
	...
	private void jButtonSilActionPerformed(ActionEvent evt) {
		...
		try {
			...
			if (jTableRandevular.getSelectedRow() >= 0) {
				...
				JOptionPane.showMessageDialog(null, "Randevu silme işlemi başarılı bir şekilde gerçekleştirildi");
			} else {
